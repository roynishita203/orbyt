# SubVault Landing Page Component

This is a modular landing page component for the SubVault website. It's designed to be easily imported and used in any Next.js application.
...
- `/favicon.svg` - The SubVault favicon
...
\`\`\`jsx
import { Hero, Services } from "@/components/landing-page"
